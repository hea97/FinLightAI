...
def test_dashboard_requests_do_not_mutate_development_database(monkeypatch, isolated_dashboard_database):
    with isolated_dashboard_database() as development_db:
        before = (
